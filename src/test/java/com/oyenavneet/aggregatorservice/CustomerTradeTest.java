...
public class CustomerTradeTest extends AbstractIntegrationTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CustomerTradeTest.class);


    @Test
    public void tradeSuccess(){
        // mock customer-service trade success response
        mockCustomerTrade("customer-services/customer-trade-200.json", 200);
    ...
    public void tradeFailure(){
        ...
        mockCustomerTrade("customer-services/customer-trade-400.json", 400);
